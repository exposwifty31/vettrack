...
import {
  ...
  Cable, Webhook, BellRing, RadioTower, Users, ShieldCheck, ScrollText,
} from "lucide-react";
...
export function IconSidebar() {
  ...
  const renderItem = (n: { id: string; href: string; labelKey: string; icon: string }) => {
  ...
  return (
    ...
    >
      ...
      {managementItems.length > 0 && <SidebarDivider />}
