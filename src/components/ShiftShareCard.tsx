    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <div style={{ color: "rgba(255,255,255,0.7)", fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase" }}>Shift Summary</div>
      ...
      {heroPct !== null && (
        <div style={{ padding: "24px 28px 0" }}>
          <div style={{ marginBottom: 8, display: "flex", alignItems: "baseline", gap: 6 }}>
            ...
            <span style={{ fontSize: 14, color: TEXT2, fontWeight: 500 }}>tasks done</span>
          </div>
      ...
      <div style={{ padding: "20px 28px 0", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, flex: 1 }}>
        ...
        >
          <div style={{ fontSize: 11, color: TEXT2, letterSpacing: "0.06em", textTransform: "uppercase", fontWeight: 600 }}>Scans Today</div>
          <div style={{ fontSize: 32, fontWeight: 800, color: TEXT, lineHeight: 1 }}>{scansToday}</div>
          <div style={{ fontSize: 11, color: TEXT2 }}>equipment scans</div>
        </div>
        ...
        >
          <div style={{ fontSize: 11, color: streak > 0 ? "rgba(255,255,255,0.7)" : TEXT2, letterSpacing: "0.06em", textTransform: "uppercase", fontWeight: 600 }}>Streak</div>
          ...
          <div style={{ fontSize: 11, color: streak > 0 ? "rgba(255,255,255,0.7)" : TEXT2 }}>
            {streak > 0 ? "days in a row" : "start your streak"}
          </div>
        </div>
        ...
        >
          <div>
            <div style={{ fontSize: 11, color: TEXT2, letterSpacing: "0.06em", textTransform: "uppercase", fontWeight: 600 }}>Tasks Completed</div>
      ...
      <div style={{ padding: "16px 28px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ fontSize: 11, color: TEXT2, fontWeight: 500 }}>VetTrack · Shift Report</div>
