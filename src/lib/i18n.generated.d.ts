...
export interface TStructure {
  ...
  board: {
    ...
    stateUnconfigured: string;
    stateUnconfiguredHint: string;
    freshnessNow: string;
    freshnessUnderMinute: string;
    freshnessMinutes: string;
    allClearEvidence: string;
    opsShiftTitle: string;
    opsEmptyWaitlist: string;
    opsEmptyStaging: string;
    responsiblesAggregate: string;
    responsiblesNoneShift: string;
    responsiblesNoSenior: string;
    responsiblesDoctorCount: string;
    responsiblesUnavailable: string;
