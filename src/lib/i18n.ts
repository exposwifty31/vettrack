...
const translations = {
  ...
  equipmentNfc: {
    ...
    writeFailed: (msg?: string) => msg || d.equipmentNfc.writeFailed,
    writeUnsupported: d.equipmentNfc.writeUnsupported,
    bindConflict: d.equipmentNfc.bindConflict,
    bindFailed: (msg?: string) => msg || d.equipmentNfc.bindFailed,
    writeTag: d.equipmentNfc.writeTag,
    lockTag: d.equipmentNfc.lockTag,
    lockConfirmTitle: d.equipmentNfc.lockConfirmTitle,
    lockConfirmBody: d.equipmentNfc.lockConfirmBody,
    lockConfirmAction: d.equipmentNfc.lockConfirmAction,
