    ...
    <>
      ...
      {!isOpen && (
        ...
        >
          ...
          {chat.unreadCount > 0 && (
            <span aria-hidden="true" className="absolute -top-1 -end-1 bg-[var(--status-issue-fg)] text-[var(--on-ink)] text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center border-2 border-background">
