...
import { EquipmentScanStatusDialog } from "@/features/equipment-detail/EquipmentScanStatusDialog";
import { EquipmentReportIssueDialog } from "@/features/equipment-detail/EquipmentReportIssueDialog";
import { EquipmentLockNfcTagDialog } from "@/features/equipment-detail/EquipmentLockNfcTagDialog";
...
function EquipmentDetailPageDesktop() {
  ...
  function invalidateAll() {
    ...
    // return/checkout doesn't leave a stale custodian on the detail.
  ...
  const pageContent = (
    <>
      ...
      <EquipmentReportIssueDialog
        open={reportIssueOpen}
        onOpenChange={setReportIssueOpen}
        equipmentDisplayName={equipmentDisplayName}
        note={reportIssueNote}
        setNote={setReportIssueNote}
        noteError={reportIssueNoteError}
        setNoteError={setReportIssueNoteError}
        photo={reportIssuePhoto}
        setPhoto={setReportIssuePhoto}
        photoInputRef={reportIssuePhotoRef}
        onPhotoChange={handleReportIssuePhotoChange}
        onSubmit={handleReportIssueSubmit}
        isPending={reportIssueMut.isPending}
      />
      ...
      <EquipmentLockNfcTagDialog
        open={lockTagDialogOpen}
        onOpenChange={setLockTagDialogOpen}
        isPending={isLockingTag}
        onConfirm={lockEquipmentNfcTag}
      />
