...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunityAppleSignIn", path: "../../../node_modules/.pnpm/@capacitor-community+apple-sign-in@7.1.0_@capacitor+core@8.4.0/node_modules/@capacitor-community/apple-sign-in"),
        ...
        .package(name: "CapgoCapacitorNfc", path: "../../../node_modules/.pnpm/@capgo+capacitor-nfc@8.0.28_@capacitor+core@8.4.0/node_modules/@capgo/capacitor-nfc")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
