...
**Repo scope:** this tree is **maintenance-only** for Capacitor. Expo/RN work lives in [`exposwifty31/VetTrack---RN-Migration-`](https://github.com/exposwifty31/VetTrack---RN-Migration-); `@vettrack/contracts` is authored **in-repo** at [`packages/contracts/`](../../packages/contracts) (pnpm `workspace:*`). See [`../MAINTENANCE_MODE.md`](../MAINTENANCE_MODE.md).
