...
| 6 | Split `src/types/index.ts` by domain + barrel | Medium — **6a–6g** merged; **6h** ER/display/Code Blue planned — [plan](./src-types-split-plan.md) · [6h](./slice-6h-er-display-types-plan.md) |
