...
**Last updated:** 2026-05-27 (post-merge PR #494)
...
| **WTL-UX-02a — Waiter ETA context** | **Complete** | Merged via PR #494 (`dce98fac`). `HolderReturnContext` + `computeHolderReturnEstimate`. |
| **WTL-UX-02b — Holder reminder + queue** | **Complete** | Merged via PR #494. `buildReturnReminderPushBody` when `countEquipmentWaitlistWaiting > 0`. |
...
- WTL-UX-02 (done): `docs/follow-ups/WTL-UX-02-estimated-return-waitlist-integration.md`
