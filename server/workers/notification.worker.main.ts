 ...
 * Run as a separate process: pnpm run worker — via ./notification.worker.ts, which
 * validates the environment BEFORE this module (and its import-time side effects) loads.
 */
