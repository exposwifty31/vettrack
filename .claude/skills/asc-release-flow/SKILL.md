...
description: Use when the question is "can my app be ready to submit?" and you need to drive the App Store release flow with the asc CLI — including first-time submission fixes for availability, in-app purchases, subscriptions, Game Center, and App Privacy.
---

# asc Release Flow (readiness-first)
