...
**Format reference:** CodeTour `.tour` JSON — see the existing `.tours/governance-architect-delivery.tour` for the shape. (The vendored ECC `code-tour` sub-skill this used to require was removed 2026-08-19 with the rest of the ECC plugin tree.)
