...
## Toolbox
- Skills [repo]: `apple-platform-ux`, `nfc-tools`, `expo-native-ui`, `app-icon`
...
- Companion Expo/React Native migration repo (`literate-dollop`) consumes `@vettrack/contracts` — contract bumps may need a cross-repo PR.
