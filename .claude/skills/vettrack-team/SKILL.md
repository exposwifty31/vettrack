...
4. **Invoke the mapped resources** of the lead, every consultant, AND every applicable standing veto per their own trigger rules; record each veto's check (pass or block, with the doctrine line cited) before work proceeds.
