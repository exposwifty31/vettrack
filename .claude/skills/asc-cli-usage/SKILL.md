---
name: asc-cli-usage
description: Use when asked to run or design asc commands, or interact with App Store Connect via the CLI — covers command discovery, canonical verbs, flag conventions, output formats, authentication, and timeouts.
---
